...
?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        <li role="presentation" class=""><a href="<?php echo base_url('minsurance/iedit');?>">保険者情報の入力</a></li>
                        <li role="presentation" class="active"><a href="javascript:;">保険者情報の一覧</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="page_container" class="container">
        <form class="horizontal-form"  id="frm_insurance_list" method="POST">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <div class="orange-row">保険者検索には、「キーワード検索」と「絞り込み」が使えます。「利用者の選択」、「詳細確認」、「削除」が可能です。</div>
                </div>
            </div>
        </div>
        ...
        <div class="search-area">
            ...
            <div class="row form-group">
                <div class="col-sm-9">
                    <select class="form-control col-sm-3" name="sel_user_search_employment" id="sel_user_search_employment">
                        <option value="99" selected="true">保険者名で絞り込む</option>
                    </select>
                </div>
                <div class="col-sm-3">
            ...
            <table class="table-green">
                <tr>
                    ...
                    <td class="text-center col-sm-2">保険者番号</td>
                    <td class="text-center col-sm-1">保険者名</td>
                    <td class="text-center col-sm-2">表示順</td>
                </tr>
                    ...
                    <?php }else{?>
                        ...
                        <tr>
                            <td class="text-center"><a href="<?php echo base_url('minsurance/iedit?mem='.$user['insurer_id']);?>" class="btn btn-xs btn-default">詳細</a></td>
                            <td class="text-center"><a href="#"  class="btn btn-xs btn-default delete_insurer" data-insurer_id="<?php echo $user['insurer_id'];?>">削除</a></td>
                            <td><?php echo $user['insurer_id'];?></td>
                            <td><?php echo $user['insurer_name'];?></td>
                            <td><?php echo $user['sort_id'];?></td>
                        </tr>
                        <?php }
                    }?>
            </table>
...
<script src="<?php echo base_url("assets/js/custom/manager/insurance_list.js");?>"></script>