            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        ...
                        <li role="presentation" class=""><a href="<?php echo base_url('minsurance/ilist');?>">保険者情報の一覧</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script src="<?php echo base_url("assets/js/custom/manager/insurance_edit.js");?>"></script>