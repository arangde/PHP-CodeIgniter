            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        <li role="presentation" class=""><a href="<?php echo base_url('mcontract/cedit');?>">利用者(被保険者)情報の入力</a></li>
            ...
            <table class="table-green">
                ...
                <?php if($history_flag == 1){?>
                    ...
                    <?php }else{?>
                        ...
                        <tr>
                            <td class="text-center"><a href="<?php echo base_url('mcontract/cedit?cid='.$contract['contract_id']);?>" class="btn btn-xs btn-default">詳細</a></td>
                ...
                <?php }else{?>
                    ...
                    <?php }else{?>
                        ...
                        <tr>
                            <td class="text-center"><a href="<?php echo base_url('mcontract/cedit?cid='.$contract['contract_id']);?>" class="btn btn-xs btn-default">詳細</a></td>
                            <td class="text-center"><a href="javascript:;"  class="btn btn-xs btn-default btn_delete_contract" data-contract_id="<?php echo $contract['contract_id'];?>">削除</a></td>
                            <td><?php echo $contract['c_username'];?></td>
                            <td><?php echo $contract['c_birthday'];?></td>
                            <td><?php echo '介護度';?></td>
                            <td><?php echo '認定状況';?></td>
...
<script src="<?php echo base_url("assets/js/custom/manager/contract_list.js");?>"></script>
