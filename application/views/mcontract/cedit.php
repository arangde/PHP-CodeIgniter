            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        ...
                        <li role="presentation" class=""><a href="<?php echo base_url('mcontract/clist');?>">利用者(被保険者)情報の一覧</a></li>
                    </ul>
                </div>
            </div>
        </div>
         ...
         <input type="hidden" name="hdn_change_fields" id="hdn_change_fields" value="<?php echo $service_fields?>" />
            ...
            <table class="table-green th-center">
                ...
                <tr>
                    <th>適用事業所</th>
                    <td colspan="2">
                        <?php echo $contract_data['office_name'];?>
                        <input type="hidden" name="sel_c_office_id" id="sel_c_office_id" value="<?php echo $contract_data['office_id'];?>" />
                    </td>
                </tr>
                <tr>
...
<script src="<?php echo base_url("assets/js/custom/manager/contract_edit.js");?>"></script>
