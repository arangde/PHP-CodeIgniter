            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        <li role="presentation" class=""><a href="<?php echo base_url('puseslip/uscreate');?>">利用・提供票の入力</a></li>
...
<script src="<?php echo base_url("assets/js/custom/person/useslip_edit.js");?>"></script>
