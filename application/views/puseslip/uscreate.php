...
<?php echo $this->load->view('puseslip/usinput'); ?>
    <div class="dark-bar">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        ...
                        <li role="presentation" class=""><a href="<?php echo base_url('puseslip/usedit');?>">利用・提供票の作成・編集・複写</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script src="<?php echo base_url("assets/js/custom/person/useslip_create.js");?>"></script>
