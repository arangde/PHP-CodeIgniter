            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        ...
                        <li role="presentation" class=""><a href="<?php echo base_url('pcontract/clist');?>">利用者(被保険者)情報の一覧</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script src="<?php echo base_url("assets/js/custom/person/contract_edit.js");?>"></script>
