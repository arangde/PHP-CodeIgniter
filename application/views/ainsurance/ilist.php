            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        <li role="presentation" class=""><a href="<?php echo base_url('ainsurance/iedit');?>">保険者情報の入力</a></li>
            ...
            <table class="table-green">
                <tr>
                    ...
                    <?php }else{?>
                        ...
                        <tr>
                            <td class="text-center"><a href="<?php echo base_url('ainsurance/iedit?mem='.$user['insurer_id']);?>" class="btn btn-xs btn-default">詳細</a></td>
...
<script src="<?php echo base_url("assets/js/custom/insurance_list.js");?>"></script>