            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        <li role="presentation" class=""><a href="<?php echo base_url('auseslip/uscreate');?>">利用・提供票の入力</a></li>
            ...
            <table class="table-green">
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-3">
                                <select class="form-control" name="sel_useslip_office_id" id="sel_useslip_office_id">
                                    <?php foreach($office_list as $key=>$office){?>
                                        <option value="<?php echo $office['office_id'];?>" <?php echo ($useslip_info['us_office_id']==$key)?'selected':'';?>><?php echo $office['office_name'];?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
...
<script src="<?php echo base_url("assets/js/custom/useslip_edit.js");?>"></script>
