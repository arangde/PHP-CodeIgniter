            ...
            <table class="table-green">
                ...
                <tr>
                    ...
                    <td colspan="6">
                        <div class="row">
                            <div class="col-sm-3">
                                <select class="form-control" name="sel_certinfo_office_id" id="sel_certinfo_office_id" >
                                    <?php foreach($office_data as $key=>$office){?>
                                        <option value="<?php echo $office['office_id'];?>"  <?php echo ($cert_info['cert_office_id']==$office['office_id'])?'selected':'';?>><?php echo $office['office_name'];?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
    ...
    <script src="<?php echo base_url("assets/js/custom/certinfo_manage.js");?>"></script>
