            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        <li role="presentation" class=""><a href="<?php echo base_url('muser/uedit');?>">職員情報の入力</a></li>
            ...
            <table class="table-green">
                ...
                <?php if($history_flag == 1){?>
                    ...
                    <?php }else{?>
                        ...
                        <tr>
                            <td class="text-center"><a href="<?php echo base_url('muser/uedit?mem='.$user['user_id']);?>" class="btn btn-xs btn-default">詳細</a></td>
...
<script src="<?php echo base_url("assets/js/custom/manager/user_list.js");?>"></script>