            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified dark-tabs">
                        ...
                        <li role="presentation" class=""><a href="<?php echo base_url('muser/ulist');?>">職員情報の一覧</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <form class="horizontal-form" id="frm_user_edit" method="post">
            ...
            <table class="table-green th-center">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="checkbox">
                            <label><input type="radio" name="rd_user_role" checked value="1" /> 一般権限</label>
                        </div>
                    </td>
                </tr>
                <tr>
                 ...
                 <tr>
                    ...
                    <td colspan="2">
                        <input type="hidden" name="sel_user_office_id" id="sel_user_office_id" value="<?php echo $user_data['office_id'];?>" />
                        <?php echo $user_data['office_name'];?>
...
<script src="<?php echo base_url("assets/js/custom/manager/user_edit.js");?>"></script>