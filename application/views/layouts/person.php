    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('home/index');?>">居宅介護支援管理ソフト</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="<?php echo ($active_menu == 'home')?'current':'';?>">
                        <a href="<?php echo base_url('phome/index');?>">ホーム</a>
                    </li>
                    <li class="dropdown <?php echo ($active_menu == 'contract')?'current':'';?>">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url('pcontract/cedit');?>">登録する/入力する</a></li>
                            <li><a href="<?php echo base_url('pcontract/clist');?>">一覧/編集する/削除する</a></li>
                        </ul>
                    </li>
                    <li class="<?php echo ($active_menu == 'certinfo')?'current':'';?>">
                        <a href="<?php echo base_url('pcertinfo/manage');?>">認定情報</a>
                    </li>
                    <li class="dropdown <?php echo ($active_menu == 'useslip')?'current':'';?>">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url('puseslip/uscreate');?>">予定・実績を記入する</a></li>
                            <li><a href="<?php echo base_url('puseslip/usedit');?>">作成する/編集する/削除する/複写する</a></li>
                        </ul>
                    </li>
                    <li class="dropdown <?php echo ($active_menu == 'monthlytotal')?'current':'';?>">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url('pmonthlytotal/conditionselect');?>">月次集計</a></li>
                            <li><a href="<?php echo base_url('pmonthlytotal/result');?>">月次集計一覧</a></li>
                            <li><a href="<?php echo base_url('pmonthlytotal/plancalc');?>">計画費加算</a></li>
                            <li><a href="<?php echo base_url('pmonthlytotal/billinglist');?>">月別介護請求一覧</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
