...
/**
 * Manager Corporatoin Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Mcorporation extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function info()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'mcorporation/info', $data)
    ...
    public function update()
    {
        ...
        $this->yall
            ...
            ->set('author', $this->session->userdata('author'))
            ->set('active_menu', 'admin')
            ->partial('main_content', 'mcorporation/update', $data)
            ->render('layouts/manager');    
    }
...
/* End of file mcorporation.php */
/* Location: ./application/controllers/mcorporation.php */
