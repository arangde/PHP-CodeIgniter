...
/**
 * Person Contract Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Pcontract extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function index()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'pcontract/cindex', $data)
    ...
    public function cedit()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'pcontract/cedit', $data)
            ->render('layouts/person');
    ...
    public function clist()
    {
        ...
        $contract_list_orgin = $this->contract_model->getManagerContractList($user_id, $keyword, 99, 99, 99, $kana, ITEMS_PER_PAGE, $start);
        ...
        $this->yall
            ...
            ->set('author', $this->session->userdata('author'))
            ->set('active_menu', 'contract')
            ->partial('main_content', 'pcontract/clist', $data)
            ->render('layouts/person');
...
/* End of file pcontract.php */
/* Location: ./application/controllers/pcontract.php */
