...
/**
 * Manager Insurance Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Minsurance extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function index()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'minsurance/index', $data)
    ...
    public function iedit()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'minsurance/iedit', $data)
            ->render('layouts/manager');
    }
    ...
    public function ilist()
    {
        ...
        $this->yall
            ...
            ->set('author', $this->session->userdata('author'))
            ->set('active_menu', 'admin')
            ->partial('main_content', 'minsurance/ilist', $data)
            ->render('layouts/manager');
    }
...
/* End of file minsurance.php */
/* Location: ./application/controllers/minsurance.php */
