...
/**
 * Manager Office Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Moffice extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function index()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'moffice/index', $data)
   ...
   public function oedit()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'moffice/oedit', $data)
            ->render('layouts/manager');
    }
    ...
    public function olist()
    {
        ...
        $this->yall
            ...
            ->set('author', $this->session->userdata('author'))
            ->set('active_menu', 'admin')
            ->partial('main_content', 'moffice/olist', $data)
            ->render('layouts/manager');
    }
...
/* End of file moffice.php */
/* Location: ./application/controllers/moffice.php */
