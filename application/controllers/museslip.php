...
/**
 * Master Useslip Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Museslip extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function usedit()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'museslip/usedit', $data)
            ->render('layouts/manager');
    ...
    public function uscreate()
    {
        ...
        $this->yall
            ...
            ->set('author', $this->session->userdata('author'))
            ->set('active_menu', 'useslip')
            ->partial('main_content', 'museslip/uscreate', $data)
            ->render('layouts/manager');
...
/* End of file museslip.php */
/* Location: ./application/controllers/museslip.php */
