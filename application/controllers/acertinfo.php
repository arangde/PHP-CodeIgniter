...
/**
 * Admin Certinfo Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Acertinfo extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function index()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'acertinfo/index', $data)
    ...
    public function manage()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'acertinfo/manage', $data)
            ->render('layouts/default');
    }
...
/* End of file acertinfo.php */
/* Location: ./application/controllers/acertinfo.php */
