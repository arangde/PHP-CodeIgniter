...
/**
 * Manager Certinfo Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Mcertinfo extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function index()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'mcertinfo/index', $data)
    ...
    public function manage()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'mcertinfo/manage', $data)
            ->render('layouts/manager');
    }
...
/* End of file mcertinfo.php */
/* Location: ./application/controllers/mcertinfo.php */
