...
/**
 * Manager Contract Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Mcontract extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function index()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'mcontract/cindex', $data)
    ...
    public function cedit()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'mcontract/cedit', $data)
            ->render('layouts/manager');
    ...
    public function clist()
    {
        ...
        $this->yall
            ...
            ->set('author', $this->session->userdata('author'))
            ->set('active_menu', 'contract')
            ->partial('main_content', 'mcontract/clist', $data)
            ->render('layouts/manager');
...
/* Location: ./application/controllers/mcontract.php */
