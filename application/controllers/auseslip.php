...
/**
 * Admin Useslip Controller
 * Created by: arangde
 * Date: 07/10/2016
 *
 */
class Auseslip extends CI_Controller
{
    protected $logged;
    protected $role;
    ...
    public function usedit()
    {
        ...
        $this->yall
            ...
            ->partial('main_content', 'auseslip/usedit', $data)
            ->render('layouts/default');
    ...
    public function uscreate()
    {
        ...
        $this->yall
            ...
            ->set('author', $this->session->userdata('author'))
            ->set('active_menu', 'useslip')
            ->partial('main_content', 'auseslip/uscreate', $data)
            ->render('layouts/default');
...
/* End of file auseslip.php */
/* Location: ./application/controllers/auseslip.php */
