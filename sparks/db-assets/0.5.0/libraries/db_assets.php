...
class Db_assets
{
	...
	public function __construct()
	{
        ...
        $this->cssLibrary = $this->CI->config->item('google_css_library');
        ...
        $this->img_dir = $this->CI->config->item('img_dir');
	}
     ...
     * @return string
     */
    public function remote_css($css, $version = NULL)
    {
        /**
         * Checking if library exists
         */
        if( !isset($this->cssLibrary[$css]))
        {
            return NULL;
        }
        ...
        if( !isset($version))
        {
            $version = $this->cssLibrary[$css]['latest'];
        }
         ...
         */
            ...
            $url = sprintf($this->cssLibrary[$css]['path'], $version);


        /**
         * Returning the chunk of HTML
         */
        return sprintf($this->templates['css'], $url, NULL);
    }
    ...
    public function img($img){
        $url = base_url() . $this->assets_dir . "/" . $this->img_dir . "/";

        /**
         * Create and return HTML chunk
         */
        return sprintf($this->templates['img'], $url.$img);
    }
