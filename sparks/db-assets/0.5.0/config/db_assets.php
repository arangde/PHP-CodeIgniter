...
$config['google_libraries'] = array(
    ...
    'jquerymobile' => array(
        'path' => 'http://code.jquery.com/mobile/1.2.0/jquery.mobile-1.2.0.min.js',
        'path_u' => 'http://code.jquery.com/mobile/1.2.0/jquery.mobile-1.2.0.js',
        'latest' => '1.2.0'
    ),
	'mootools' => array(
...
$config['google_css_library'] = array(
    'jquery_mobile_css' => array(
        'path' => 'http://code.jquery.com/mobile/1.2.0/jquery.mobile.structure-1.2.0.min.css',
        'latest' => '1.2.0',
    ),
);
